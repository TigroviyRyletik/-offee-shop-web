...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!context.Products.Any())
    {
        ...
        context.Products.AddRange(
            ...
            new coffe_poject.Models.Product { Name = "Еспресо", Description = "Ідеальний, густий та ароматний шот еспресо.", Price = 150, CategoryId = category.Id, ImageUrl = "/images/espresso.png" },
            ...
            new coffe_poject.Models.Product { Name = "Бамбл Кава", Description = "Хіт сезону: еспресо, апельсиновий фреш та карамельний сироп з льодом.", Price = 260, CategoryId = coldCategory.Id, ImageUrl = "/images/bumble_v2.png" },
